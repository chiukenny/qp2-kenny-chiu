...
&= \left(\frac{\sigma^2+NT\tau^2}{N}\right)U -\tau^2\sum_{i=1}^I\left(\sum_{j=1}^TX_{ij}\right)^2 \;. \tag{*}
\end{align*}
where line $(*)$ follows because $X_{ij}=X_{ij}^2\in\{0,1\}$. Let $V = \sum_{i=1}^I\left(\sum_{j=1}^TX_{ij}\right)^2$. Therefore,
\[
\bfX^\T\bfV^{-1}\bfX =
\begin{bmatrix}
\frac{NIT}{\sigma^2+T\tau^2} & \frac{NU}{\sigma^2+T\tau^2} \\
\frac{NU}{\sigma^2+T\tau^2} & \frac{NU}{\sigma^2} - \frac{N^2\tau^2V}{\sigma^4+NT\sigma^2\tau^2}
\end{bmatrix} \;.
\]
By the formula for the inverse of a $2\times 2$ matrix, we then have
\begin{align*}
\Var(\hat{\theta}) &= \bfe_2^\T(\bfX^\T\bfV^{-1}\bfX)^{-1}\bfe_2 \\
&= \left(\frac{NIT}{\sigma^2+T\tau^2}\right)\left(\left(\frac{NIT}{\sigma^2+T\tau^2}\right)\left(\frac{NU}{\sigma^2} - \frac{N^2\tau^2V}{\sigma^4+NT\sigma^2\tau^2}\right)-\left(\frac{NU}{\sigma^2+T\tau^2}\right)^2\right)^{-1} \\
&= \left(\frac{NIT}{\sigma^2+T\tau^2}\right)\left(\left(\frac{NIT}{\sigma^2+T\tau^2}\right)\left(\frac{NU\sigma^2+N^2\tau^2(UT-V)}{\sigma^4+NT\sigma^2\tau^2}\right)-\left(\frac{NU}{\sigma^2+T\tau^2}\right)^2\right)^{-1} \\
&= \left(\frac{NU\sigma^2+N^2\tau^2(UT-V)}{\sigma^4+NT\sigma^2\tau^2}-\frac{N^2U^2}{NIT(\sigma^2+T\tau^2)}\right)^{-1}
\end{align*}
