...
\midrule
1.0 &&  0.050 & 0.089 & 0.081 && 0.066 & 0.052 && 0.062 & &  && 0.058 & 0.053 \\
0.7 && 0.700 & 0.736 & 0.723 && 0.805 & 0.711 && 0.345 & & && 0.779 & 0.688 \\
0.6 && 0.920 & 0.928 & 0.920 && 0.963 & 0.929 && 0.536 & & && 0.951 & 0.913 \\
0.5 && 0.981 & 0.983 & 0.982 && 0.994 & 0.985 && 0.719$^*$ & & && 0.997 & 0.985 \\
\bottomrule
\end{tabular}
...
Due to time constraints on this report, we do not replicate the power simulation study with jackknife estimates of the variance. \citeauthor{Hussey:2007} also are unclear about how they compute the jackknife estimate. We propose an jackknife estimator that we believe would be reasonable and may be the one that they used.
